...
We will use the dataset from Rangel DaCosta et al. (2024) to implement a
segmentation model.
...
We will use the dataset from Shi et al. (2022) to implement a
...
We will use the dataset from Sadri et al. (2024) to implement a
denoising model for 4DSTEM data.
...
We will use a simulated dataset from the IMN chair to implement an Image
to image translation model.
